...
echo "pyenv update; rbenv update; sudo apt update; sudo apt-file update; sudo apt upgrade -y; sudo apt full-upgrade -y; sudo apt autoremove -y; sudo apt autoclean;" > ~/.zhistory
chmod -w ~/.zhistory
