...
def set_proxy_alias_to_profile(user):
    user_home_path = os.path.expanduser("~" + user)
    profile = user_home_path + "/" + ".profile"
    file.set_to_file(profile, 'alias pon="export http_proxy=http://127.0.0.1:8118 https_proxy=http://127.0.0.1:8118 all_proxy=socks5://127.0.0.1:1080"')
    file.set_to_file(profile, 'alias poff="unset http_proxy https_proxy all_proxy"')
