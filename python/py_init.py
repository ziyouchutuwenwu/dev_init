...
if __name__ == "__main__":
    ...
    os.system("sudo apt install -y make build-essential libssl-dev zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev wget curl llvm libncurses5-dev libncursesw5-dev xz-utils tk-dev libffi-dev liblzma-dev")
    ...
    os.system("echo index-url = https://pypi.tuna.tsinghua.edu.cn/simple >> ~/.pip/pip.conf")
    os.system("echo [install] >> ~/.pip/pip.conf")
    os.system("echo '# mac下默认的pip安装目录错误，需要自定义一下，版本号注意修改' >> ~/.pip/pip.conf")
    os.system("echo '# install-option=--prefix=~/.pyenv/versions/3.6.5' >> ~/.pip/pip.conf")
