...
defmodule ClientDemo do
  ...
  def get_demo do
    ...
    {:ok, %HTTPoison.Response{status_code: 200, body: body}} =
      HTTPoison.get("http://127.0.0.1:4000/api/get-demo?aaa=bbb", headers, options)
  ...
  def uri_demo do
    ...
    {:ok, %HTTPoison.Response{status_code: 200, body: body}} =
      HTTPoison.get("http://127.0.0.1:4000/api/uri-demo/ppp", headers, options)
  ...
  def file_upload_demo do
    ...
    {:ok, %HTTPoison.Response{status_code: 200, body: body}} =
      HTTPoison.put("http://127.0.0.1:4000/api/file-upload", file_bin, headers, options)
