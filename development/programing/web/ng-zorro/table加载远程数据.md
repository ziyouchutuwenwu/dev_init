...
export class AjaxTableDemoComponent implements OnInit {
  ...
  constructor(
    private ajaxService: AjaxTableService,
...
func main() {
    ...
    s.Group("/", func(group *ghttp.RouterGroup) {
        group.ALL("/demo/aaa", func(r *ghttp.Request) {

            pageIndex := r.GetInt("page_index")
            pageSize := r.GetInt("page_size")

            fmt.Println(pageIndex, pageSize)

            jsonList := garray.Array{}
